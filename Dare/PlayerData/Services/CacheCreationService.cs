...
namespace Dare.PlayerData.Services;
...
public sealed class CacheCreationService : DisposableMediatorSubscriberBase
{
    ...
    public CacheCreationService(ILogger<CacheCreationService> logger, DareMediator mediator, GameObjectHandlerFactory gameObjectHandlerFactory,
