...
using CharacterData = Dare.PlayerData.Data.CharacterData;
...
public class PlayerDataFactory
{
    ...
    public PlayerDataFactory(ILogger<PlayerDataFactory> logger, DalamudUtilService dalamudUtil, IpcManager ipcManager,
        ...
        PerformanceCollectorService performanceCollector, XivDataAnalyzer modelAnalyzer, DareMediator mareMediator)
    {
        _logger = logger;
