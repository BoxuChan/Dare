...
public record DareCharaFileData
{
    ...
    public DareCharaFileData() { }
    public DareCharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static DareCharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<DareCharaFileData>(Encoding.UTF8.GetString(data))!;
    }
