...
public sealed partial class CharaDataManager : DisposableMediatorSubscriberBase
{
    ...
    public CharaDataManager(ILogger<CharaDataManager> logger, ApiController apiController,
        ...
        DareMediator mareMediator, IpcManager ipcManager, DalamudUtilService dalamudUtilService,
    ...
    public Task<(DareCharaFileHeader LoadedFile, long ExpectedLength)>? LoadedMcdfHeader { get; private set; }
    ...
    public void SaveDareCharaFile(string description, string filePath)
    {
