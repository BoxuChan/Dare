...
public sealed class DareMediator : IHostedService
{
    ...
    public DareMediator(ILogger<DareMediator> logger, PerformanceCollectorService performanceCollector, DareConfigService mareConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting DareMediator");
        ...
        _logger.LogInformation("Started DareMediator");
