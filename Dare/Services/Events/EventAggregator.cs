...
namespace Dare.Services.Events;
...
public class EventAggregator : MediatorSubscriberBase, IHostedService
{
    ...
    public EventAggregator(string configDirectory, ILogger<EventAggregator> logger, DareMediator mareMediator) : base(logger, mareMediator)
    {
