...
public sealed class PerformanceCollectorService : IHostedService
{
    ...
    public PerformanceCollectorService(ILogger<PerformanceCollectorService> logger, DareConfigService mareConfigService)
    {
        _logger = logger;
        _mareConfigService = mareConfigService;
    }

    public T LogPerformance<T>(object sender, DareInterpolatedStringHandler counterName, Func<T> func, int maxEntries = 10000)
    {
    ...
    public void LogPerformance(object sender, DareInterpolatedStringHandler counterName, Action act, int maxEntries = 10000)
    {
