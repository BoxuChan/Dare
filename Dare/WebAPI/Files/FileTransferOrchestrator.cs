...
public class FileTransferOrchestrator : DisposableMediatorSubscriberBase
{
    ...
    private readonly DareConfigService _mareConfig;
    ...
    public FileTransferOrchestrator(ILogger<FileTransferOrchestrator> logger, DareConfigService mareConfig,
        DareMediator mediator, TokenProvider tokenProvider, HttpClient httpClient) : base(logger, mediator)
    {
        _mareConfig = mareConfig;
        _tokenProvider = tokenProvider;
        _httpClient = httpClient;
        var ver = Assembly.GetExecutingAssembly().GetName().Version;
        _httpClient.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("Dare", ver!.Major + "." + ver!.Minor + "." + ver!.Build));
    ...
    public long DownloadLimitPerSlot()
    {
        ...
        {
            DareConfiguration.Models.DownloadSpeeds.Bps => limit,
            DareConfiguration.Models.DownloadSpeeds.KBps => limit * 1024,
            DareConfiguration.Models.DownloadSpeeds.MBps => limit * 1024 * 1024,
            _ => limit,
        };
