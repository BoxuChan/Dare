...
public class ConfigurationSaveService : IHostedService
{
    ...
    public ConfigurationSaveService(ILogger<ConfigurationSaveService> logger, IEnumerable<IConfigService<IDareConfiguration>> configs)
    {
...
#pragma warning restore S3011 // Reflection should not be used to increase accessibility of classes, methods, or fields
    ...
    private async Task SaveConfig<T>(IConfigService<T> config) where T : IDareConfiguration
    {
