...
public class CreateSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public CreateSyncshellUI(ILogger<CreateSyncshellUI> logger, DareMediator mareMediator, ApiController apiController, UiSharedService uiSharedService,
        PerformanceCollectorService performanceCollectorService)
        : base(logger, mareMediator, "Create new Syncshell###DareSynchronosCreateSyncshell", performanceCollectorService)
    {
    ...
    protected override void DrawInternal()
    {
        ...
        if (_lastCreatedGroup == null)
        {
            ...
            UiSharedService.TextWrapped("(Those preferred permissions can be changed anytime after Syncshell creation, your defaults can be changed anytime in the Dare Settings)");
        }
        else
        {
