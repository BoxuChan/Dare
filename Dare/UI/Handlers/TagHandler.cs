...
namespace Dare.UI.Handlers;

public class TagHandler
{
    public const string CustomAllTag = "Dare_All";
    public const string CustomOfflineTag = "Dare_Offline";
    public const string CustomOfflineSyncshellTag = "Dare_OfflineSyncshell";
    public const string CustomOnlineTag = "Dare_Online";
    public const string CustomUnpairedTag = "Dare_Unpaired";
    public const string CustomVisibleTag = "Dare_Visible";
