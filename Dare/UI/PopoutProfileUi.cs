...
public class PopoutProfileUi : WindowMediatorSubscriberBase
{
    ...
    public PopoutProfileUi(ILogger<PopoutProfileUi> logger, DareMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, DareConfigService mareConfigService,
        DareProfileManager mareProfileManager, PairManager pairManager, PerformanceCollectorService performanceCollectorService) : base(logger, mediator, "###DareSynchronosPopoutProfileUI", performanceCollectorService)
    {
    ...
    protected override void DrawInternal()
    {
        ...
        try
        {
            ...
            var mareProfile = _mareProfileManager.GetDareProfile(_pair.UserData);
