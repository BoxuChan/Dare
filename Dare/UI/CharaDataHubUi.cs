...
internal sealed partial class CharaDataHubUi : WindowMediatorSubscriberBase
{
    ...
    public CharaDataHubUi(ILogger<CharaDataHubUi> logger, DareMediator mediator, PerformanceCollectorService performanceCollectorService,
        ...
        : base(logger, mediator, "Dare Character Data Hub###DareSynchronosCharaDataUI", performanceCollectorService)
    {
        ...
        Mediator.Subscribe<GposeStartMessage>(this, (_) => IsOpen |= _configService.Current.OpenDareHubOnGposeStart);
    ...
    {
        _uiSharedService.BigText("Dare Character Data File Export");

        DrawHelpFoldout("This feature allows you to pack your character into a MCDF file and manually send it to other people. MCDF files can officially only be imported during GPose through Dare. " +
        ...
        if (_readExport)
        {
            ...
            if (_uiSharedService.IconTextButton(FontAwesomeIcon.Save, "Export Character as MCDF"))
            {
                ...
                _uiSharedService.FileDialogManager.SaveFileDialog("Export Character to file", ".mcdf", defaultFileName, ".mcdf", (success, path) =>
                {
                    ...
                    _charaDataManager.SaveDareCharaFile(_exportDescription, path);
    ...
    private void DrawSettings()
    {
        ...
        ImGuiHelpers.ScaledDummy(5);
        bool openInGpose = _configService.Current.OpenDareHubOnGposeStart;
        if (ImGui.Checkbox("Open Character Data Hub when GPose loads", ref openInGpose))
        {
            _configService.Current.OpenDareHubOnGposeStart = openInGpose;
            _configService.Save();
        }
