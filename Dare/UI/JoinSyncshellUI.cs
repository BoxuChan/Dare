...
internal class JoinSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public JoinSyncshellUI(ILogger<JoinSyncshellUI> logger, DareMediator mediator,
        UiSharedService uiSharedService, ApiController apiController, PerformanceCollectorService performanceCollectorService) 
        : base(logger, mediator, "Join existing Syncshell###DareSynchronosJoinSyncshell", performanceCollectorService)
    {
