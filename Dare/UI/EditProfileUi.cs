...
public class EditProfileUi : WindowMediatorSubscriberBase
{
    ...
    public EditProfileUi(ILogger<EditProfileUi> logger, DareMediator mediator,
        ApiController apiController, UiSharedService uiSharedService, FileDialogManager fileDialogManager,
        DareProfileManager mareProfileManager, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Dare Synchronos Edit Profile###DareSynchronosEditProfileUI", performanceCollectorService)
    {
        IsOpen = false;
    ...
    protected override void DrawInternal()
    {
        ...
        var profile = _mareProfileManager.GetDareProfile(new UserData(_apiController.UID));
        ...
        ImGui.TextWrapped($"- All users that are paired and unpaused with you will be able to see your profile picture and description.{Environment.NewLine}" +
            ...
            $"- In case of valid reports from other users this can lead to disabling your profile forever or terminating your Dare account indefinitely.{Environment.NewLine}" +
