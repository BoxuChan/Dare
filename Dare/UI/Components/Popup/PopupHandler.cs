...
public class PopupHandler : WindowMediatorSubscriberBase
{
    ...
    public PopupHandler(ILogger<PopupHandler> logger, DareMediator mediator, IEnumerable<IPopupHandler> popupHandlers,
        PerformanceCollectorService performanceCollectorService, UiSharedService uiSharedService)
        : base(logger, mediator, "DarePopupHandler", performanceCollectorService)
    {
