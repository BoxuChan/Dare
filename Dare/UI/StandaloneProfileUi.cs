...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(ILogger<StandaloneProfileUi> logger, DareMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, DareProfileManager mareProfileManager, PairManager pairManager, Pair pair,
        PerformanceCollectorService performanceCollector)
        : base(logger, mediator, "Dare Profile of " + pair.UserData.AliasOrUID + "##DareSynchronosStandaloneProfileUI" + pair.UserData.AliasOrUID, performanceCollector)
    {
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var mareProfile = _mareProfileManager.GetDareProfile(Pair.UserData);
