...
public sealed class IpcCallerGlamourer : DisposableMediatorSubscriberBase, IIpcCaller
{
    ...
    public IpcCallerGlamourer(ILogger<IpcCallerGlamourer> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, DareMediator mareMediator,
    ...
    public void CheckAPI()
    {
        ...
        finally
        {
            if (!apiAvailable && !_shownGlamourerUnavailable)
            {
                ...
                _mareMediator.Publish(new NotificationMessage("Glamourer inactive", "Your Glamourer installation is not active or out of date. Update Glamourer to continue to use Dare. If you just updated Glamourer, ignore this message.",
